...
if ($_POST && !empty($_POST['DNI']) && !empty($_POST['nombre']) && !empty($_POST['rpassword'])){
    $sql= "INSERT INTO registro (DNI, nombre, rpassword) VALUES (:DNI, :nombre, :rpassword)";
...
<?php 
require 'conexion.php';
if ($_POST && !empty($_POST['DNI']) && !empty ($_POST['rpassword'])){
                ...
                <div class="form-content">
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" id="confirm_rpassword" name="confirm_rpassword"
                                required="required" />
                        </div>
                        <div class="form-group">
